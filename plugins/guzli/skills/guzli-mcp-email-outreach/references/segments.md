...
- [ ] Create the authorized segment with `guzli:create_segment`, supplying a
...
- [ ] Substitute this audience_policy into the campaign creation arguments:
...
- [ ] Run only within the authorized scope after verifying readiness and enrollment.
